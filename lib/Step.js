  ...
  _createClass(Step, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          customCircleStyle = _props2.customCircleStyle,
          customTitleStyle = _props2.customTitleStyle,
          customCircleClass = _props2.customCircleClass,
          customTitleClass = _props2.customTitleClass;


      var styles = this.getStyles();
      var circleStyle = Object.assign(styles.circle, completed ? styles.completedCircle : {}, active ? styles.activeCircle : {}, customCircleStyle || {});
      var titleStyle = Object.assign(styles.title, completed ? styles.completedTitle : {}, active ? styles.activeTitle : {}, customTitleStyle || {});
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: circleStyle, className: customCircleClass },
          active || completed ? _react2.default.createElement(
            'a',
            { href: href, onClick: onClick, style: styles.index, className: customTitleClass },
            stepContent
          ) : _react2.default.createElement(
            'span',
            { style: styles.index, className: customTitleClass },
            stepContent
          )
        ),
        active || completed ? _react2.default.createElement(
